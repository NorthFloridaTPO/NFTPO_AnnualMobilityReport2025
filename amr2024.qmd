...
df_pop <- read.csv("~/GitHub/AnnualMobilityReport2024/data/population.csv")
...
```{r}
# Load data
df_drivers <- read.csv("~/GitHub/AnnualMobilityReport2024/data/drivers.csv")
# Define your custom colors
...
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/underserved.geojson", quiet = TRUE)  %>% 
...
```{r}
df_gdp <- read.csv("~/GitHub/AnnualMobilityReport2024/data/GDP.csv")
# Create a Highchart object with data labels and stack totals
...
# Data
# Load data
df_emp <- read.csv("~/GitHub/AnnualMobilityReport2024/data/employment.csv")
...
df_lottr <- read.csv("~/GitHub/AnnualMobilityReport2024/data/tourism.csv", check.names=FALSE, row.names=1) 
...
```{r}
df_tot_crash <- read.csv("~/GitHub/AnnualMobilityReport2024/data/total_crashes.csv")
...
df_fatalserious <- read.csv("~/GitHub/AnnualMobilityReport2024/data/fatalseriouscrashes.csv")
...
```{r}
df_tot_fat <- read.csv("~/GitHub/AnnualMobilityReport2024/data/total_fatalities.csv")
...
```{r}
df_tot_inj <- read.csv("~/GitHub/AnnualMobilityReport2024/data/total_injuries.csv")
...
# Filter data for PedFatal > 0
df_crash_rates <- read.csv("~/GitHub/AnnualMobilityReport2024/data/crash_rates.csv")
...
::: {layout="[ [1,1] ]"}
```{r}
df_bike_ped <- read.csv("~/GitHub/AnnualMobilityReport2024/data/NF_Bike_Ped_fatalcrashes_19_23.csv")
...
```{r}
df_tot_imp <- read.csv("~/GitHub/AnnualMobilityReport2024/data/total_impaired.csv")
...
df_vmt <- read.csv("~/GitHub/AnnualMobilityReport2024/data/vmt.csv")
...
df_pmt <- read.csv("~/GitHub/AnnualMobilityReport2024/data/pmt.csv")
...
```{r}
df_transit <- read.csv("~/GitHub/AnnualMobilityReport2024/data/transit_ridership.csv")
...
```{r}
df_cruise <- read.csv("~/GitHub/AnnualMobilityReport2024/data/cruise_passengers.csv")
...
```{r}
df_ton_ship <- read.csv("~/GitHub/AnnualMobilityReport2024/data/tons_shipped.csv")
...
```{r}
# Load data
df_item_ship <- read.csv("~/GitHub/AnnualMobilityReport2024/data/autos_containers_shipped.csv")
...
# Filter data for PedFatal > 0
df_air_pass <- read.csv("~/GitHub/AnnualMobilityReport2024/data/air_passengers.csv")
...
```{r}
df_cargo <- read.csv("~/GitHub/AnnualMobilityReport2024/data/air_cargo.csv")
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/Florida_TMC_LOTTR23.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
df_lottr <- read.csv("~/GitHub/AnnualMobilityReport2024/data/LOTTR_updated_2022.csv", check.names=FALSE, row.names=1) 
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/Florida_TMC_TTTR23.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
df_tttr <- read.csv("~/GitHub/AnnualMobilityReport2024/data/TTTR.csv", check.names=FALSE, row.names=1) 
...
df_percentage_heavy_congested <- read.csv("~/GitHub/AnnualMobilityReport2024/data/percent_heavily_congested.csv", check.names=FALSE, row.names=1) 
...
df_duration_heavy_congested <- read.csv("~/GitHub/AnnualMobilityReport2024/data/duration_heavily_congested.csv", check.names=FALSE, row.names=1) 
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/MajorRoads_LOS.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
leaflet() %>%
  ...
  addProviderTiles(providers$CartoDB.Positron) %>%
  setView(lng = -81.655651, lat = 30.232184, zoom = 9)%>%
  addPolylines(data = geojson_data, color = ~colors,popup = ~paste("<b>Facility: </b>", geojson_data$Facility, "<br><b>County: </b>", geojson_data$COUNTY, "<br><b>LOS Peak Hour: </b>", LOS_Peak_H), opacity = 0.8, label = ~lapply(labs, htmltools::HTML))%>%
  addEasyButton(
    easyButton(
      icon = 'fa-map-marker',
      title = "Zoom to Jacksonville",
...
df_vhd <- read.csv("~/GitHub/AnnualMobilityReport2024/data/vehicle_delay.csv")
# Create a Highchart object with data labels and stack totals
...
# Filter data for PedFatal > 0
df_travel <- read.csv("~/GitHub/AnnualMobilityReport2024/data/travel_speeds.csv")
...
::: {layout="[ [1,1] ]"}
```{r}
df_inc_all <- read.csv("~/GitHub/AnnualMobilityReport2024/data/incident_clearance_all.csv")
...
```{r}
# Load data
df_duration <- read.csv("~/GitHub/AnnualMobilityReport2024/data/road_duration_all.csv")
...
```{r}
df_events <- read.csv("~/GitHub/AnnualMobilityReport2024/data/event_types_all.csv")
...
df_pnr <- read.csv("~/GitHub/AnnualMobilityReport2024/data/ParkNRide.csv")
point_data <- data.frame(
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/TransitAll_Routes.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/LTS_Bike_Ped.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326) %>%
  drop_na(Bike_LTS)
...
```{r}
# knitr::include_graphics("~/GitHub/AnnualMobilityReport2024/data/ETDM.png")

# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/fdot_wp.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
df_c02 <- read.csv("~/GitHub/AnnualMobilityReport2024/data/C02DamageCosts.csv", check.names=FALSE, row.names=1) 
datatable(
  caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: left;',
...
# Load your GeoJSON file
geojson_data <- st_read("~/GitHub/AnnualMobilityReport2024/data/nftpo_trails.geojson", quiet = TRUE)  %>% 
  st_transform(crs = 4326)
...
```{r, message=FALSE}
# Load your GeoJSON file
geojson_data_unfiltered <- st_read("~/GitHub/AnnualMobilityReport2024/data/Sidewalks_and_Gaps_NF.geojson", quiet = TRUE)
...
df_pfc <- read.csv("~/GitHub/AnnualMobilityReport2024/data/PrimaryFreightCorridorsPoorPavement.csv", check.names=FALSE, row.names=1) 
...
df_pavement <- read.csv("~/GitHub/AnnualMobilityReport2024/data/preserveandmaintain.csv", check.names=FALSE, row.names=1) 
datatable(caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: left;',
    htmltools::HTML('Source: <a href="https://fdotsourcebook.com/federal-measures/pavement" target="_blank"><b>FDOT Source Book, PM2-Pavement</b></a>')),
...
df_lottr <- read.csv("~/GitHub/AnnualMobilityReport2024/data/bridgeconditions.csv", check.names=FALSE, row.names=1) 
datatable(caption = htmltools::tags$caption(
    style = 'caption-side: top; text-align: left;',
...
# Filter data for PedFatal > 0
df_transit_age <- read.csv("~/GitHub/AnnualMobilityReport2024/data/transit_age.csv")
...
```{r}
df_cost_con <- read.csv("~/GitHub/AnnualMobilityReport2024/data/cost_congestion.csv")
